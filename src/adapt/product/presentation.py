...
SUBJECT_THEMES = {
    "mathematics": {
        "theme": "math",
        "label": "Mathematics",
        "blurb": "Numbers, algebra, geometry, and trigonometry.",
        "visual": "equation",
    },
    "calculus": {
        "theme": "calculus",
        "label": "Calculus",
        "blurb": "Limits, derivatives, integrals, and rates of change.",
        "visual": "graph",
    },
    "computer-science": {
        "theme": "cs",
        "label": "Computer Science",
        "blurb": "Programs, structures, algorithms, and data.",
        "visual": "code",
    },
    "physics": {
        "theme": "physics",
        "label": "Physics",
        "blurb": "Motion, forces, energy, and waves.",
        "visual": "diagram",
    },
    "chemistry": {
        "theme": "chemistry",
        "label": "Chemistry",
        "blurb": "Atoms, bonds, reactions, and pH.",
        "visual": "molecule",
    },
    "space": {
        "theme": "space",
        "label": "Space",
        "blurb": "Planets, stars, galaxies, and orbits.",
        "visual": "scale",
    },
    "quantum": {
        "theme": "quantum",
        "label": "Quantum",
        "blurb": "Explore qubits, superposition, entanglement and quantum gates.",
        "visual": "qubit",
    },
}
