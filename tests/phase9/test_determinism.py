...
def test_m9_011_determinism():
    ...
    sa = a.create_session(concept_id="cs_complexity", session_id="P9-DET-A", max_steps=1)
    sb = b.create_session(concept_id="cs_complexity", session_id="P9-DET-B", max_steps=1)
